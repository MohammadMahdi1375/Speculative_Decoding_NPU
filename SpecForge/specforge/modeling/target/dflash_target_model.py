...
class HFDFlashTargetModel(DFlashTargetModel):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        _weight_files = glob.glob(_os.path.join(pretrained_model_name_or_path, "*.safetensors")) +                         glob.glob(_os.path.join(pretrained_model_name_or_path, "pytorch_model*.bin"))
        if _weight_files:
